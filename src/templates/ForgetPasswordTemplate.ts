const ForgetPasswordTemplate = (name: string, link: string) => {
  return `
    ...
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Thank you for be with us. Please consider clicking below link to reset your password.</p>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 32px; line-height: 1.5em; margin-top: 0; text-align: center;">
        <a href="${link}"  style="text-decoration:none; padding: 10px 20px; color:white; border:1px solid gray; border-radius:12px; background-color: indigo;font-size:22px;">
            Reset Password
        </a>
    </p>
    ...
    If above button not work please copy/paste this url <a href="${link}">${link}</a>
  </p>
